...
create:function(game){
    ...
    _this.rollsound = _this.add.audio('rollSound');
     _this.coinDrop = _this.add.audio('coinDrop');
    //baudio.play();
    //baudio.loopFull(0.6);
...
loadAssets:function(){
  ...
  _this.currency = _this.add.sprite(30,75,'currency');
  _this.chart = _this.add.sprite(30,195,'chart');
 /*----Invisible notes----in Upper table--*/
  _this.note_10Draggable = _this.add.sprite(55,90,'note_10');
  ...
  _this.note_1Draggable = _this.add.sprite(160,90,'note_1');
  ...
  _this.coin_10Draggable = _this.add.sprite(288,110,'coin_10');
  ...
  _this.coin_1Draggable = _this.add.sprite(352,110,'coin_1');
 ...
 /*-----note frames in chart---*/
  _this.frame_10_note = _this.add.sprite(45,285,'10_note');
  _this.frame_10_note.frame =0 ;
  _this.frame_1_note = _this.add.sprite(255,285,'1_note');
  _this.frame_1_note.frame = 0;
  _this.frame_10_coin = _this.add.sprite(520,260,'10_coin');
  _this.frame_10_coin.frame = 0;
  _this.frame_1_coin = _this.add.sprite(650,260,'1_coin');
  _this.frame_1_coin.frame = 0;


  /*----Single notes in chart that are invisible----*/
  _this.note_10_chartDrag = _this.add.sprite(45,335,'note_10frame');
  ...
  _this.note_1_chartDrag = _this.add.sprite(255,335,'note_1frame');
  ...
  _this.coin_10_chartDrag = _this.add.sprite(520,455,'coin_10frame');
  ...
  _this.coin_1_chartDrag = _this.add.sprite(650,455,'coin_1frame');
...
question1:function(){
    ...
    _this.group1 = _this.add.group()
     ...
     _this.loadAssets();
    /*---right side box----*/
     _this.box1 = _this.add.sprite(770,75,'box1');
...
/*----right side box Text----*/
    ...
    _this.dot = _this.add.sprite(68,-10,'dot');
    ...
    /*----Answer Boxes---*/
     _this.box2A = _this.add.sprite(40,400,"box2");
    ...
    _this.box2B = _this.add.sprite(155,400,"box2");
    ...
    _this.box2C = _this.add.sprite(270,400,"box2");
    ...
    _this.box2D = _this.add.sprite(385,400,"box2");
    ...
    _this.box2E = _this.add.sprite(500,400,"box2");
    ...
    _this.box2F = _this.add.sprite(615,400,"box2");
  ...
  /*------First Answer Box Text--------*/
    ...
    _this.div = _this.add.sprite(20,52,"div");
...
/*----Second Answer Box Text-----*/
    ...
    _this.tickmark = _this.add.sprite(860,433,'tickmark');
        ...
        switch(_this.qArrays[_this.qno])
        {
             ...
             case 10:
                if(_this.tweened == false)
                    ...
                    {
                         _this.src.setAttribute("src", "voice/English/nsd6.5a.mp3");
                    }
                    else if(selctedLang.selectedlanguage =="Hindi")
                    {
                         _this.src.setAttribute("src", "voice/Hindi/nsd6.5a.mp3");
                    }
                    else if(selctedLang.selectedlanguage =="Kannada")
                    {
                         _this.src.setAttribute("src", "voice/Kannada/nsd6.5a.mp3");
                    }
                    else if(selctedLang.selectedlanguage =="Gujarati")
                    {
                         _this.src.setAttribute("src", "voice/Gujarati/nsd6.5a.mp3");
                    }        
                     else
                    {
                        _this.src.setAttribute("src", "voice/Odiya/nsd6.5a.mp3");
                ...
                else
                    {
                          if(selctedLang.selectedlanguage =="English")
                    {
                         _this.src.setAttribute("src", "voice/English/nsd6.5b.mp3");
                    }
                    else if(selctedLang.selectedlanguage =="Hindi")
                    {
                         _this.src.setAttribute("src", "voice/Hindi/nsd6.5b.mp3");
                    }
                    else if(selctedLang.selectedlanguage =="Kannada")
                    {
                         _this.src.setAttribute("src", "voice/Kannada/nsd6.5b.mp3");
                    }
                    else if(selctedLang.selectedlanguage =="Gujarati")
                    {
                         _this.src.setAttribute("src", "voice/Gujarati/nsd6.5b.mp3");
                    }        
                     else
                    {
                        _this.src.setAttribute("src", "voice/Odiya/nsd6.5b.mp3");
						_this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
                    }
